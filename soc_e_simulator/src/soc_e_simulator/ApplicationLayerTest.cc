...
#include "soc_e_simulator/ApplicationLayerTest.h"

#include "soc_e_simulator/ApplicationLayerTestMessage_m.h"

using namespace veins;
using namespace soc_e_simulator;

Define_Module(soc_e_simulator::ApplicationLayerTest);
